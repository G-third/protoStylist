const checkboxRadioView = {
    ...
    getPreviewHTML: (state) => {
        ...
        const checkboxPreviewsHTML = checkStates.map(s => {
            ...
            return `
                <div class="mb-6 flex flex-col items-start w-full">
                    ...
                    <span class="text-xs text-zinc-500 dark:text-zinc-400 font-mono whitespace-nowrap">${tokenName}</span>
                </div>
            `;
        }).join('');
        ...
        const radioPreviewsHTML = `
            <div role="radiogroup" class="flex flex-col gap-6">
                <div class="flex flex-col items-start w-full">
                    ...
                    <span class="text-xs text-zinc-500 dark:text-zinc-400 font-mono whitespace-nowrap">.form-radio:checked</span>
                </div>
                <div class="flex flex-col items-start w-full">
                    <div class="flex items-center mb-2">
                        <label class="inline-flex items-center cursor-pointer">
                    ...
                    <span class="text-xs text-zinc-500 dark:text-zinc-400 font-mono whitespace-nowrap">.form-radio</span>
                </div>
                <div class="flex flex-col items-start w-full">
                    <div class="flex items-center mb-2">
                    ...
                    <span class="text-xs text-zinc-500 dark:text-zinc-400 font-mono whitespace-nowrap">.form-radio:disabled</span>
                </div>
            </div>
        `;
        ...
        return `
            <div class="mb-20">
                <h4 class="pst-preview-heading mb-6 mt-8 text-sm font-semibold">Checkbox</h4>
                <div class="flex flex-col gap-2">${checkboxPreviewsHTML}</div>
                <h4 class="pst-preview-heading mb-6 mt-12 text-sm font-semibold">Radio Button</h4>
                ${radioPreviewsHTML}
            </div>
        `;
    },
